...
from .models import (
    AnalyzeProjectRequest, PreflightCheckRequest, CreateADRRequest, 
    ApproveADRRequest, SupersedeADRRequest, PlanningContextRequest,
    ...
    try:
        ...
        if result.success:
            ...
            return success_response(
                ...
                metadata={"old_adr": request.old_adr_id, "new_adr": supersede_result.new_adr_id}
            )
        else:
            return error_response(
