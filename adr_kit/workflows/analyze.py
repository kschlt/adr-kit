    ...
    def _generate_analysis_prompt(
        ...
        prompt_parts.extend(
            [
                ...
                "",
                "4. **AI Fitness Assessment:** For each architectural decision, assess its AI implementation fitness:",
                "   - Feedback loop quality (type safety, error messages, test speed)",
                "   - Documentation accessibility (machine-readable official docs?)",
                "   - Decision space (convention-driven or many valid approaches?)",
                "   - Modularity (bounded changes or everything-touches-everything?)",
                "   - Known AI pitfalls with this technology",
                "",
                "   Document both the decision AND its AI fitness in the ADR consequences.",
                "   Flag technologies that score poorly - these need mitigation strategies.",
                "",
                "5. Wait for human approval before accepting each proposed ADR",
                "",
