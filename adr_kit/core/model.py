...
class ImportPolicy(BaseModel):
    ...
    disallow: Optional[List[str]] = Field(
        None, description="List of disallowed imports/libraries"
    )
    prefer: Optional[List[str]] = Field(
...
class BoundaryPolicy(BaseModel):
    ...
    layers: Optional[List[BoundaryLayer]] = Field(
        None, description="Architectural layers"
    )
...
class PythonPolicy(BaseModel):
    ...
    disallow_imports: Optional[List[str]] = Field(
...
class PolicyModel(BaseModel):
    ...
    rationales: Optional[List[str]] = Field(
        None, description="Rationales for the policies"
    )

    @field_validator("rationales", mode="before")
    @classmethod
    def ensure_rationales_list_or_none(cls, v: Any) -> Optional[List[str]]:
...
class ADRFrontMatter(BaseModel):
    ...
    deciders: Optional[List[str]] = Field(
    ...
    @classmethod
    def ensure_list_or_none(cls, v: Any) -> Optional[List[str]]:
    ...
    @classmethod
    def validate_superseded_status(cls, v: Any, info: Any) -> Optional[List[str]]:
...
class ADR(BaseModel):
    ...
    @property
    def deciders(self) -> Optional[List[str]]:
