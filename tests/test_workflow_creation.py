...
"""
    ...
    def test_adr_id_generation_with_existing(self, temp_adr_dir, sample_creation_input, existing_adr):
    ...
    def test_missing_required_fields(self, temp_adr_dir):
        ...
        assert any("decision" in error.lower() or "consequence" in error.lower() 
    ...
    def test_very_long_title_handling(self, temp_adr_dir):
        ...
        long_title = "Use a very long technology name that exceeds normal title length limits and might cause file system issues " * 3
